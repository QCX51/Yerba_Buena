...
class MapsFragment : Fragment(), GoogleMap.OnCameraIdleListener, LocationListener, GoogleMap.OnMarkerDragListener, GoogleMap.OnMapLongClickListener {
    ...
    private val permReqLauncher =
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            ...
            else
            {
                ...
                builder.setTitle("Permiso requerido").setMessage("")
    ...
    private  fun getCurrentLocation()
    {
        ...
        {
            var builder: AlertDialog.Builder = AlertDialog.Builder(requireContext())
            builder.setTitle("Error").setMessage(ex.message)
            builder.setPositiveButton("OK") { dialog, which -> }
            builder.create().show()
    ...
    private fun getLocationPermission() {
            ...
            != PackageManager.PERMISSION_GRANTED)
        {
            ...
            permReqLauncher.launch(arrayOf(Manifest.permission.ACCESS_FINE_LOCATION))
                ...
                Manifest.permission.ACCESS_FINE_LOCATION))
        {
            Toast.makeText(requireContext(), "${R.string.msg_request_permission_rationale}", Toast.LENGTH_SHORT).show()
            permReqLauncher.launch(arrayOf(Manifest.permission.ACCESS_FINE_LOCATION))
        }
        else
        {
